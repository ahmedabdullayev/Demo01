        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContactTypeValue = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PersonPictureId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Persons", x => x.id);
                    table.ForeignKey(
                        name: "FK_Persons_PersonPictures_PersonPictureId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ContactValue = table.Column<string>(type: "nvarchar(36)", maxLength: 36, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Persons_PersonPictureId",
                table: "Persons",
                column: "PersonPictureId",
                unique: true,
                filter: "[PersonPictureId] IS NOT NULL");
        }
